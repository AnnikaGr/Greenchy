...
function renderData(co2_data, activity_worst_emissions, onSelectTransport) {
	function visualizeCo2EmissionsCB(activity_co2_emissions) {
		return (
			<div key={activity_co2_emissions} class="column is-one-third has-text-centered">
				<text class="subtitle is-5"> {activity_co2_emissions[0]} </text> <br />
				<button onClick={() => onSelectTransport(activity_co2_emissions)} class="button is-primary is-outlined">
					+ Add to trip
				</button>{" "}
				<br />
	...
	return (<div class="columns is-mobile is-centered">
		...
		<div class="scroll-hint content">
			...
			<span class="icon-text">
				...
				<span>Scroll down to see your full impact</span>
				<span class="icon">
					<i class="fa-solid fa-arrow-down"></i>
				</span>
			</span>
